...
function main() {
    ...
    function drawStartScreen() {
        ...
        context.fillText("move: WASD", 5, (startpoint + (line++) * fontsize));
        context.fillText("switch: yellow / U", 5, (startpoint + (line++) * fontsize));
        context.fillText("drop: green / I", 5, (startpoint + (line++) * fontsize));
        context.fillText("start: just move", 5, (startpoint + (line++) * fontsize));
